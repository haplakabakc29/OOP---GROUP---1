...
public class browsePage extends JFrame implements ActionListener {
    ...
    private loggedUser userBP;
    
    ArrayList<String> cartItems = new ArrayList<>();
    ArrayList<Integer> cartPrices = new ArrayList<>();

        public browsePage(loggedUser user) {
        this.userBP = user;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == btnProfile ) {
            ViewProfile vp = new ViewProfile(userBP, this);
            vp.setVisible(true);
        }
